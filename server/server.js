 ...
 * 设置目标环境变量的值
 */
global.environment = process.env.TARGET_ENV;
//如果未设置目标环境，则默认为dev环境
if (environment == undefined || environment == '' || environment == null) {
...
// }
app.listen(serverData.port);
console.log('Server proxy on port: ', serverData.port, ' , on environment: ', global.environment);
